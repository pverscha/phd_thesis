...
Each visualization exposes an interface that data needs to adhere to in order to be able to visualize.
...
I've had a lot of help from James Collier (VIB) and Alexander Botzki (VIB) for this.
